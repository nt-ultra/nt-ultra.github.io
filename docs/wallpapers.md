...
Any image format. Any gif. The limit is set to 200MB per image (animated wallpapers ✔). And 8 wallpapers total. These limitations are set in [consideration of IndexDB](https://rxdb.info/articles/indexeddb-max-storage-limit.html).
